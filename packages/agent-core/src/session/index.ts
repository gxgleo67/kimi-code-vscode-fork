...
export interface SessionOptions {
  ...
  /**
   * Host UI mode (`'cli'`, `'print'`, `'vscode'`, ...), threaded from the
   * owning core. Gates host-specific behavior such as the LLM-generated
   * session title, so CLI behavior stays unchanged.
   */
