...
export const en = {
  ...
  "accounts.manage": "Add or remove accounts…",
  "accounts.rename": "Rename display name",
  "accounts.renameFailed": "Rename failed",
  "accounts.setDefault": "Set as the default account (new sessions start on its model)",
  "accounts.setDefaultFailed": "Failed to set the default account",
  "accounts.defaultBadge": "Default",
  "accounts.switched": "Switched to {name} (this window only)",
  "accounts.switchFailed": "Failed to switch account: {error}",
  "accounts.customProviders": "Third-party APIs",
  "accounts.usageLoading": "Loading quota…",
  "accounts.usageUnavailable": "Quota unavailable",
  ...
  // ── Engine error codes (inline error card / toasts) ──────────────────────
  "error.quotaExhausted": "Quota exhausted or insufficient balance — recharge or wait for the quota reset, then retry.",
  "error.code.CLI_NOT_FOUND": "Kimi Code CLI not found.",
  "error.code.SPAWN_FAILED": "Failed to start Kimi Code CLI.",
  "error.code.ALREADY_STARTED": "A session is already running.",
  "error.code.STDIN_NOT_WRITABLE": "Failed to communicate with Kimi Code CLI.",
  "error.code.HANDSHAKE_TIMEOUT": "Connection timed out.",
  "error.code.PROCESS_CRASHED": "Process connection lost.",
  "error.code.LLM_NOT_SET": "Authentication failed. Please sign in.",
  "error.code.LLM_NOT_SUPPORTED": "This model is not supported.",
  "error.code.INVALID_STATE": "Please wait for the current operation.",
  "error.code.CHAT_PROVIDER_ERROR": "Service temporarily unavailable.",
  "error.code.SESSION_BUSY": "A message is being sent. Please wait.",
  "error.code.SESSION_CLOSED": "Session was closed.",
  "error.code.TURN_INTERRUPTED": "Stopped by user.",
  "error.code.INVALID_JSON": "Communication format error.",
  "error.code.INVALID_REQUEST": "Invalid request.",
  "error.code.INVALID_PARAMS": "Invalid parameters.",
  "error.code.INTERNAL_ERROR": "Internal error occurred.",
  "error.code.config.invalid": "Kimi Code configuration is invalid.",
  "error.code.model.not_configured": "No model is configured. Please sign in or configure a provider.",
  "error.code.session.not_found": "Session was not found.",
  "error.code.session.state_not_found": "Session data is missing.",
  "error.code.session.state_invalid": "Session data is invalid.",
  "error.code.session.init_failed": "Failed to initialize the session.",
  "error.code.session.fork_active_turn": "Wait for the current response before forking.",
  "error.code.provider.rate_limit": "Too many requests. Please try again later.",
  "error.code.provider.auth_error": "Authentication failed. Please sign in again.",
  "error.code.provider.connection_error": "Could not connect to the model provider.",
  "error.code.provider.filtered": "The response was filtered by content policy.",
  "error.code.request.prompt_input_empty": "Prompt cannot be empty.",
  ...
  "permMode.yolo": "YOLO",
  "permMode.auto": "Auto",
  "permMode.tooltipManual": "Manual mode: tool calls need your approval — Shift+Tab to cycle",
  "permMode.tooltipYolo": "YOLO mode: tool calls are auto-approved; the agent may still ask questions — Shift+Tab to cycle",
  "permMode.tooltipAuto": "Auto mode: fully autonomous; tool calls are auto-approved and questions auto-dismissed — Shift+Tab to cycle",
