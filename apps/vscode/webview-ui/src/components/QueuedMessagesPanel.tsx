  ...
  return (
    <div className="group flex items-start px-2.5 py-0.5 hover:bg-muted/50 transition-colors">
      <div className="flex-1 min-w-0">
        <p className="text-xs line-clamp-2 text-foreground">{text || (hasMedia ? t("queue.media") : "")}</p>
        {hasMedia && text && <span className="text-[10px] text-muted-foreground">{t("queue.plusMedia")}</span>}
      </div>
