...
export interface GetBackgroundPayload {
  ...
  /**
   * Also list terminal tasks that ran attached to a foreground tool call.
   * Settled attached tasks are hidden by default because their result was
   * already delivered inline; activity-feed UIs opt in.
   */
