...
const EXTENSION_ID = "moonshot-ai.kimicode-vscode-fork";
const EXPECTED_COMMANDS = [
  "kimifork.clearAllState",
  "kimifork.focusInput",
  "kimifork.insertMention",
  "kimifork.logout",
  "kimifork.migrateLegacyData",
  "kimifork.newConversation",
  "kimifork.openInSideBar",
  "kimifork.openInTab",
  "kimifork.resetKimi",
  "kimifork.showLogs",
];
...
exports.run = async function run() {
  ...
  const config = vscode.workspace.getConfiguration("kimifork");
  ...
  await vscode.commands.executeCommand("kimifork.openInTab");
  await waitFor(() => {
  ...
  await vscode.commands.executeCommand("kimifork.showLogs");
  await vscode.commands.executeCommand("kimifork.resetKimi");
